        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex justify-content-end w-100 mt-md-0 mt-sm-3">
                <?php if ($_SESSION["cuisinier"] == false and $_SESSION["particulier"] == false) { ?>
                    ...
                    <button type="button" class="btn btn-light me-3 px-4 hvr-pulse-grow" data-bs-toggle="modal" data-bs-target="#choix_inscription">S'inscrire</button>
                    <!-- Modal -->
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body d-flex justify-content-around py-5">
                                    <a href="index.php?page=form_particulier" class="btn btn-warning text-uppercase px-4 hvr-grow">Particulier</a>
                                    <a href="index.php?page=form_cuisinier" class="btn btn-warning text-uppercase px-4 hvr-grow">Cuisinier</a>
                                </div>
                    ...
                    <!-- Button trigger modal -->
                    <button type="button" class="btn btn-light px-4 hvr-pulse-grow" data-bs-toggle="modal" data-bs-target="#form_connexion">Connexion</button>
                    <!-- Modal -->
